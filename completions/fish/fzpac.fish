...
complete -c fzpac -n '__fish_use_subcommand' -x -a 'p view' -d 'SEARCH FOR: all available packages'
complete -c fzpac -n '__fish_use_subcommand' -x -a 'v view-local' -d 'SEARCH FOR: already installed packages'
